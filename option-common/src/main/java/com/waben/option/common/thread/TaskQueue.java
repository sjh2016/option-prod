...
public class TaskQueue extends LinkedBlockingQueue<Runnable> {
    ...
    private volatile com.waben.option.common.thread.ThreadPoolExecutor parent = null;
    ...
    public void setParent(com.waben.option.common.thread.ThreadPoolExecutor tp) {
        parent = tp;
    }
