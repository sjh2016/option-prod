...
@FeignClient(value = "admin-core-server", contextId = "AdminMissionActivityAPI", qualifier = "adminMissionActivityAPI")
public interface AdminMissionActivityAPI extends BaseAPI {
