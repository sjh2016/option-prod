...
@FeignClient(value = "admin-core-server", contextId = "AdminTreasureChestAPI", qualifier = "adminTreasureChestAPI")
public interface AdminTreasureChestAPI extends BaseAPI {
