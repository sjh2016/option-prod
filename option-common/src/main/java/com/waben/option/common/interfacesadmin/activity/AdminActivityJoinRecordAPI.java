...
@FeignClient(value = "admin-core-server", contextId = "AdminActivityJoinRecordAPI", qualifier = "adminActivityJoinRecordAPI")
public interface AdminActivityJoinRecordAPI extends BaseAPI {
