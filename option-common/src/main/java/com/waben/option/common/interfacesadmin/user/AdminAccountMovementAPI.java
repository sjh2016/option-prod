...
@FeignClient(value = "admin-core-server", contextId = "AdminAccountMovementAPI", qualifier = "adminAccountMovementAPI", path = "/user/movement")
public interface AdminAccountMovementAPI extends BaseAPI {
