...
@FeignClient(value = "admin-core-server", contextId = "AdminWithdrawOrderAPI", qualifier = "adminWithdrawOrderAPI")
public interface AdminWithdrawOrderAPI extends BaseAPI {
