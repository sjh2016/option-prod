...
public class AddressUtil {
    ...
    public static String getAddresses(String ip, String encodingString) {
        ...
        paramMap.put("ip", ip);
        HttpUtil.requestPostJsonData(urlStr, null, paramMap,
    ...
    public static void main(String[] args) throws IOException {
        // 创建 GeoLite2 数据库
        File database = ResourceUtils.getFile(ClassLoader.getSystemResource("ip/GeoLite2-City.mmdb").getPath());
        // 读取数据库内容
        DatabaseReader reader = new DatabaseReader.Builder(database).build();
        InetAddress ipAddress = InetAddress.getByName("119.8.182.66");
        // 获取查询结果
