...
import com.waben.option.common.exception.StopPooledThreadException;
...
public class ThreadPoolExecutor extends java.util.concurrent.ThreadPoolExecutor {
    ...
    protected boolean currentThreadShouldBeStopped() {
        if (threadRenewalDelay >= 0
            && Thread.currentThread() instanceof com.waben.option.common.thread.TaskThread) {
            com.waben.option.common.thread.TaskThread currentTaskThread = (com.waben.option.common.thread.TaskThread) Thread.currentThread();
