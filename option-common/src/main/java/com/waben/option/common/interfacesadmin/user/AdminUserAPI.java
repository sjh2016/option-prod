...
@FeignClient(value = "admin-core-server", contextId = "AdminUserAPI", qualifier = "adminUserAPI")
public interface AdminUserAPI extends BaseAPI {
    ...
    public Response<List<UserTreeNodeDTO>> _queryUserTreeNode(@RequestParam(value = "userId", required = false) Long userId);
    ...
    public default List<UserTreeNodeDTO> queryUserTreeNode(Long userId) {
        return getResponseData(_queryUserTreeNode(userId));
    }
