...
import com.waben.option.core.service.simulate.InvestDataService;

@RestController
@RequestMapping("/investData")
public class InvestDataController extends AbstractBaseController {

	@Resource
	private InvestDataService service;
