...
@Mapper
public interface AccountStatementDao4 extends AccountStatementStaDao<AccountStatement4> {
    ...
    @Select({"<script>", "SELECT\n" +
            ...
            "LEFT JOIN (SELECT id,user_id,amount FROM `t_u_account_statement4` WHERE `type` IN ('CREDIT_INVITE_WAGER', 'CREDIT_SUBORDINATE')) e ON e.user_id=b.id\n" +
