...
public class LoginService {
    ...
    public Map<String, Object> login(String username, String password, String ip, String code, AuthorityEnum authorityType, PlatformEnum platform) {
        ...
        UserDTO user = userAPI.login(username, password, ip, code);
        ...
        userAPI.cleanToken(user.getId());
        userAPI.storeToken(user.getId(), newToken);
...
//    @Transactional(rollbackFor = Exception.class)
    public Map<String, Object> googleLogin(String token, Integer source, String userIp) {
        try {
            ...
            if (!userAPI.verifyUsername(username)) userAPI.register(buildRegister(username, password, source, userIp));
