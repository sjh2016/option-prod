...
import com.waben.option.common.interfaces.resource.BankCodeAPI;
...
public class BankCodeController extends AbstractBaseController {
	...
	@Resource
	private BankCodeAPI bankCodeAPI;
	...
	public ResponseEntity<?> query(@RequestParam(value = "name", required = false) String name,
		...
		return ok(bankCodeAPI.query(name, code, staticConfig.getDefaultCurrency().name()));
	}
