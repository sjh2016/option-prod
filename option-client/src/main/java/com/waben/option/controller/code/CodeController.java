...
public class CodeController extends AbstractBaseController {
	...
	public ResponseEntity<?> send(@RequestParam(value = "areaCode", required = false) String areaCode,
			@RequestParam("username") String username) {
		smsService.send(areaCode, username, EmailTypeEnum.VERIFY_CODE, null, getUserIp());
		return ok();
	}
	...
	@RequestMapping(value = "/sms/queryCodeNew", method = RequestMethod.GET)
	...
	public ResponseEntity<?> verifyCredential(@RequestParam("ticket") String ticket,
	...
	public ResponseEntity<?> verifyImageCode(@RequestParam(value = "moveLength") String moveLength,
			@RequestParam(value = "xWidth") Integer xWidth) {
